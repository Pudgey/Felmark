---
name: "diagnose"
description: "Run systematic parallel hypothesis debugging on the specified target. Alias for debug. Use when the user explicitly invokes $diagnose or asks for debugging help."
---

# Diagnose — Parallel Hypothesis Debugging
