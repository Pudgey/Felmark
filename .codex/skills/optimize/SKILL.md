---
name: "optimize"
description: "Run the multi-mode strategy engine on the specified target. Use when the user explicitly invokes $optimize or asks for this workflow in Felmark."
---
