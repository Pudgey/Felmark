---
name: "forge"
description: "Scan the codebase and rebuild the dependency map (FORGE_MAP.md). Use when files have been created, deleted, or moved, or before a major refactor."
---

# Forge — Dependency Map Rebuild
