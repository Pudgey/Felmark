---
name: "superbrain"
description: "Load external engineering intelligence from top open source projects. Use before major refactors or when auditing codebase quality against industry standards."
---

# Superbrain — External Engineering Intelligence
...
## Context cost
High. Best run at session start or before a major refactor. Not for quick tasks.
