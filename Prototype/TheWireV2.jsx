      ...
      <div className="w">
        <div className="w-head">
          ...
          <div className="w-ticker">
            <div className="w-tick"><span className="w-tick-val" style={{ color: "#5a9a3c" }}>{filtered.length}</span><div className="w-tick-info"><span className="w-tick-label">Signals</span><span className="w-tick-change up">+4 new today</span></div></div>
            <div className="w-tick"><span className="w-tick-val" style={{ color: "var(--ember)" }}>{clientSignals}</span><div className="w-tick-info"><span className="w-tick-label">Client signals</span><span className="w-tick-change up">Action needed</span></div></div>
            <div className="w-tick"><span className="w-tick-val" style={{ color: "var(--ink-800)" }}>{avgRelevance}%</span><div className="w-tick-info"><span className="w-tick-label">Avg relevance</span></div></div>
            <div className="w-tick"><span className="w-tick-val" style={{ color: "#5b7fa4" }}>$112</span><div className="w-tick-info"><span className="w-tick-label">Avg market rate</span><span className="w-tick-change up">↑ 8% YoY</span></div></div>
            <div className="w-tick"><span className="w-tick-val" style={{ color: "#5a9a3c" }}>+34%</span><div className="w-tick-info"><span className="w-tick-label">Niche demand</span><span className="w-tick-change up">Growing</span></div></div>
            <div className="w-tick"><span className="w-tick-val" style={{ color: "#7c6b9e" }}>2.4×</span><div className="w-tick-info"><span className="w-tick-label">Strategy premium</span></div></div>
          </div>
        </div>
                  ...
                  <div className="w-pv-head">
                    ...
                    {selected.metric && (
                      <div className="w-pv-metric">
                        ...
                        {selected.spark && <div className="w-pv-metric-spark"><Spark data={selected.spark} color={tc.color} width={200} height={48} /></div>}
                      </div>
                    )}
                  </div>
