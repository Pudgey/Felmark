      ...
      <style>{`
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .sbs-editor {
          ...
          padding: 48px 40px 120px; width: 100%;
        }
        ...
        .doc-h2 {
          ...
          font-weight: 600; color: var(--ink-900); margin: 32px 0 12px;
        }
        ...
        .doc-li {
          ...
          padding: 4px 0; font-size: 15px; color: var(--ink-600); line-height: 1.7;
        }
        .doc-li-num {
          font-family: var(--mono); font-size: 12px; color: var(--ink-300);
        ...
        .doc-note {
          ...
          padding: 10px 16px; border-left: 2px solid var(--warm-300);
        ...
        .doc-insert-line {
          ...
          color: var(--warm-400); font-size: 14px;
        ...
        .bp-list::-webkit-scrollbar-thumb { background: rgba(0,0,0,0.06); border-radius: 99px; }
        .bp-item {
      ...
      <div className="sbs">
        ...
        <div className="sbs-editor">
          ...
          <div className="doc-note">
            ...
            See reference: <LinkPreviewBlock url="figma.com/file/abc" title="Typography Scale v3" source="Figma" /> and <LinkPreviewBlock url="drive.google.com/file/def" title="Mood Board — Final" source="Google Drive" />
          </div>
