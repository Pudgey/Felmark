...
export const BLOCK_TYPES: BlockTypeInfo[] = [
  ...
  { type: "graph", label: "Graph", icon: "▥", desc: "Insert a live chart", section: "Blocks", shortcut: "/graph" },
  {
    ...
    label: "Deliverable",
    icon: "☰",
    desc: "Task with files & approvals",
    section: "Blocks",
    shortcut: "/deliv",
  },
  ...
  { type: "audio", label: "Audio", icon: "●", desc: "Voice memo & transcript", section: "Blocks", shortcut: "/audio" },
  {
    ...
    label: "AI Generate",
    icon: "◈",
    desc: "Generate blocks from a prompt",
    section: "Blocks",
    shortcut: "/ai",
  },
  {
    ...
    icon: "💬",
    desc: "Discussion anchored to a block",
  ...
  },
  {
    ...
    label: "Mention",
    icon: "@",
    desc: "Tag someone with a notification",
    section: "Collaboration",
    shortcut: "/mention",
  },
  {
    ...
    label: "Question",
    icon: "?",
    desc: "Flag a question for the client",
    section: "Collaboration",
    shortcut: "/question",
  },
  {
    ...
    icon: "↺",
    desc: "Assign a reviewer with due date",
    section: "Collaboration",
    shortcut: "/feedback",
  },
  {
    ...
    label: "Decision",
    icon: "⚖",
    desc: "Log a decision with context",
    section: "Collaboration",
    shortcut: "/decision",
  },
  { type: "poll", label: "Poll", icon: "▣", desc: "Vote between options", section: "Collaboration", shortcut: "/poll" },
  {
    ...
    label: "Handoff",
    icon: "→",
    desc: "Mark ready for next person",
    section: "Collaboration",
    shortcut: "/handoff",
  },
  {
    ...
    label: "E-Signature",
    icon: "✍",
    desc: "Draw or type legally binding signatures",
    section: "Collaboration",
    shortcut: "/esign",
  },
  {
  ...
  },
  {
    ...
    label: "Canvas",
    icon: "◇",
    desc: "Sketchy whiteboard drawing",
    section: "Blocks",
    shortcut: "/canvas",
  },
  {
    ...
    label: "AI Action",
    icon: "⚡",
    desc: "Summarize, suggest, translate, tone-check, or scope-risk",
    section: "Blocks",
    shortcut: "/action",
  },
  {
    ...
    label: "Timeline",
    icon: "⏱",
    desc: "Project roadmap with phases",
    section: "Visual",
    shortcut: "/timeline",
  },
  {
    ...
    label: "Process Flow",
    icon: "◎",
    desc: "Step-by-step visual process",
    section: "Visual",
    shortcut: "/flow",
  },
  {
  ...
  },
  {
    ...
    label: "Pull Quote",
    icon: "❝",
    desc: "Testimonial with attribution",
    section: "Visual",
  ...
  },
  {
    ...
    icon: "★",
    desc: "Dramatic name reveal animation",
    section: "Visual",
    shortcut: "/spotlight",
  },
  {
    ...
    label: "Kinetic Type",
    icon: "Aa",
    desc: "Staggered text reveal",
    section: "Visual",
    shortcut: "/kinetic",
  },
  {
    type: "number-cascade",
    label: "Number Cascade",
    icon: "#",
    desc: "Animated stat grid",
    section: "Visual",
    shortcut: "/cascade",
  },
  {
    ...
    label: "Stat Reveal",
    icon: "◎",
    desc: "Animated counting stats with rings",
    section: "Visual",
    shortcut: "/stats",
  },
  {
  ...
  },
  {
    ...
    icon: "$",
    desc: "Client toggles options, total updates live",
    section: "Blocks",
    shortcut: "/pricing",
  },
  {
    ...
    icon: "⇄",
    desc: "In-scope vs out-of-scope with boundary",
    section: "Blocks",
    shortcut: "/scope",
  },
  {
    ...
    icon: "☑",
    desc: "Track what you need from the client",
    section: "Blocks",
    shortcut: "/assets",
  },
  {
    type: "decision-picker",
    label: "Decision Picker",
    icon: "⇄",
    desc: "Client picks between directions",
    section: "Blocks",
    shortcut: "/decide",
  },
  {
    type: "availability-picker",
    label: "Availability",
    icon: "◇",
    desc: "Inline meeting scheduler",
    section: "Blocks",
    shortcut: "/avail",
  },
  {
  ...
  },
  {
    ...
    label: "Drawing",
    icon: "✎",
    desc: "Pre-built visual diagrams",
    section: "Visual",
    shortcut: "/drawing",
  },
  {
    ...
    icon: "◎",
    desc: "SVG deliverable dependency graph",
    section: "Blocks",
    shortcut: "/deps",
  },
  {
    type: "revision-heatmap",
    label: "Revision Heatmap",
    icon: "█",
    desc: "Edit intensity per section",
    section: "Blocks",
    shortcut: "/heat",
  },
];
