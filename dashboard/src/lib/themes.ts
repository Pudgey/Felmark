...
export const THEMES: Record<string, FelmarkTheme> = {
  ...
  obsidian: {
    ...
    parchment: "#121110",
    warm50: "#1a1918", warm100: "#232220", warm200: "#2f2d2b", warm300: "#3d3a37", warm400: "#524e4a",
    ink900: "#ece8e2", ink800: "#d4cfc7", ink700: "#b8b2a8", ink600: "#9c958a", ink500: "#807870", ink400: "#666059", ink300: "#524e4a",
    panel: "#1a1918", panelHover: "#232220", panelActive: "#2a2826", panelBorder: "rgba(255,255,255,0.06)",
    railBg: "#0d0c0b", railIcon: "#666059", railIconActive: "#b8b2a8", railHover: "rgba(255,255,255,0.08)",
  ...
  dune: {
    ...
    parchment: "#f9f3e8",
    warm50: "#f4edd9", warm100: "#ede4cc", warm200: "#e2d7b8", warm300: "#d4c7a2", warm400: "#c1b38a",
    ink900: "#3b3122", ink800: "#504530", ink700: "#665a40", ink600: "#7d7054", ink500: "#96886a", ink400: "#afa283", ink300: "#c4b99f",
    panel: "#f2ead8", panelHover: "#ebe1cc", panelActive: "#e4d8c0", panelBorder: "rgba(0,0,0,0.04)",
    railBg: "#3b3122", railIcon: "#96886a", railIconActive: "#d4c7a2", railHover: "rgba(255,255,255,0.06)",
  ...
  ink: {
    ...
    parchment: "#fafafa",
    warm50: "#f5f5f5", warm100: "#eeeeee", warm200: "#e0e0e0", warm300: "#cccccc", warm400: "#aaaaaa",
    ink900: "#171717", ink800: "#262626", ink700: "#404040", ink600: "#525252", ink500: "#6b6b6b", ink400: "#8a8a8a", ink300: "#a3a3a3",
    panel: "#f0f0f0", panelHover: "#e8e8e8", panelActive: "#e0e0e0", panelBorder: "rgba(0,0,0,0.06)",
    railBg: "#171717", railIcon: "#6b6b6b", railIconActive: "#cccccc", railHover: "rgba(255,255,255,0.06)",
  ...
  copper: {
    ...
    parchment: "#f4f2ee",
    warm50: "#ece9e3", warm100: "#e2ded6", warm200: "#d5d0c5", warm300: "#c5bfb2", warm400: "#aea79a",
    ink900: "#28271f", ink800: "#3a382e", ink700: "#4e4b3f", ink600: "#636052", ink500: "#7b7768", ink400: "#949080", ink300: "#aca89b",
    panel: "#eae7e0", panelHover: "#e2ded6", panelActive: "#dad5cc", panelBorder: "rgba(0,0,0,0.04)",
    railBg: "#28271f", railIcon: "#7b7768", railIconActive: "#c5bfb2", railHover: "rgba(255,255,255,0.06)",
  ...
  lavender: {
    ...
    parchment: "#f9f8fc",
    warm50: "#f3f1f8", warm100: "#eae7f2", warm200: "#ddd8ea", warm300: "#cdc6de", warm400: "#b5adc9",
    ink900: "#24213a", ink800: "#35314e", ink700: "#484363", ink600: "#5d5879", ink500: "#746f8f", ink400: "#8e89a6", ink300: "#a8a4ba",
    panel: "#f0eef5", panelHover: "#eae7f2", panelActive: "#e2deed", panelBorder: "rgba(0,0,0,0.04)",
    railBg: "#24213a", railIcon: "#746f8f", railIconActive: "#cdc6de", railHover: "rgba(255,255,255,0.06)",
