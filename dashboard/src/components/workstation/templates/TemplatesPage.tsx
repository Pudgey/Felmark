...
const TEMPLATES: Template[] = [
  ...
  { id:"t15", name:"Meeting Notes", category:"scope", desc:"Structured notes from client calls. Action items auto-create tasks in the project workstation.", fields:4, pages:1, signatureSlots:0, lastUpdated:"Mar 2026", tags:["Auto-Tasks","Quick Capture"], usedCount:156, rating:4.6, preview:{ sections:[{title:"Attendees & Date",desc:"Who was there"},{title:"Discussion Points",desc:"What was covered"},{title:"Decisions Made",desc:"What was agreed"},{title:"Action Items",desc:"Tasks with owners and dates"}], fields:[{label:"Meeting Title",type:"text",placeholder:"Kickoff Call"},{label:"Client",type:"select",placeholder:"Nora Kim"}] } },
