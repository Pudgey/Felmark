    ...
    <div className={styles.mb}>
      ...
      <div className={styles.payBody}>
        ...
        <div className={styles.payBreakdown}>
          <div className={styles.payBdRow}>
            <span>Processing fee (2.9%)</span>
            <span>-${fee.toLocaleString()}</span>
          </div>
          <div className={`${styles.payBdRow} ${styles.payBdNet}`}>
        ...
        {state === "processing" && (
          <div className={styles.payProcessing}>
            <span className={styles.paySpinner} /> Processing payment...
          </div>
        )}
        {state === "success" && (
          <div className={styles.paySuccess}>
            ...
            <div>
              <span className={styles.paySuccessTitle}>Payment successful</span>
              <span className={styles.paySuccessDetail}>Receipt sent to {client}</span>
            </div>
          </div>
        )}
