    ...
    options: [
      {
        id: "logo",
        name: "Logo Design",
        desc: "Primary + secondary + icon mark",
        price: 1200,
        required: true,
        category: "Core",
      },
      {
        id: "colors",
        name: "Color Palette",
        desc: "Primary, secondary, accent, semantic",
        price: 400,
        required: true,
        category: "Core",
      },
      {
        ...
        desc: "Font pairings, scale, hierarchy",
        price: 400,
        required: true,
        category: "Core",
      },
      {
        ...
        desc: "40+ page PDF with usage rules",
        price: 800,
      ...
      },
      {
        ...
        desc: "IG, LinkedIn, X templates (12 total)",
        price: 600,
        category: "Deliverables",
      },
      {
        ...
        desc: "Business card, letterhead, envelope",
        price: 500,
        category: "Deliverables",
      },
      ...
      { id: "animation", name: "Logo Animation", desc: "5-second animated logo mark", price: 700, category: "Extras" },
      {
        ...
        desc: "2-hour workshop + positioning doc",
        price: 1500,
        category: "Extras",
      },
    ],
...
export default function PricingConfigBlock({ data, onUpdate }: Props) {
  const toggle = (id: string) => {
    ...
    const selected = data.selected.includes(id) ? data.selected.filter((s) => s !== id) : [...data.selected, id];
      ...
      <div className={styles.header}>
        <span
          ...
          style={{
            ...
            borderColor: "color-mix(in srgb, var(--ember) 10%, transparent)",
          }}
        >
          Interactive
        </span>
      ...
      <div className={styles.configBody}>
              ...
              {data.options
                ...
                .map((opt) => {
                  ...
                  return (
                    <div
                      key={opt.id}
                      className={`${styles.configOpt} ${isOn ? styles.configOptOn : ""}`}
                    ...
                    >
                      ...
                      <div className={`${styles.configOptPrice} ${isOn ? styles.configOptPriceOn : ""}`}>
        ...
        <div className={styles.configSummary}>
          ...
          <div className={styles.configSummaryItems}>
            {data.options
              .filter((o) => data.selected.includes(o.id))
              .map((o) => (
          ...
          <div className={styles.configSummaryNote}>
            {data.selected.length} of {data.options.length} options selected
          </div>
