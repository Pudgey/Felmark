    ...
    snapshots: [
      {
        ...
        desc: "Exploring 4 different logo directions based on discovery workshop",
        items: 4,
        type: "sketch",
        color: "var(--warm-400)",
      },
      {
        ...
        desc: "Client chose Direction A — organic, warm, serif-forward",
        items: 1,
        type: "decision",
        color: "var(--muted)",
      },
      {
        ...
        desc: "3 variants of chosen direction with typography pairings",
        items: 3,
        type: "design",
        color: "var(--ember)",
      },
      {
        id: "s4",
        date: "Mar 27",
        label: "Color exploration",
        desc: "5 palette options tested against accessibility standards",
        items: 5,
        type: "design",
        color: "var(--ember)",
      },
      {
        ...
        desc: "Cormorant Garamond + Outfit + JetBrains Mono — full scale defined",
        items: 1,
        type: "design",
        color: "var(--ember)",
      },
      {
        id: "s6",
        date: "Today",
        label: "Guidelines draft",
        desc: "First 20 pages of brand guidelines document in progress",
        items: 1,
        type: "current",
        color: "var(--success)",
      },
            ...
            <div key={s.id} className={`${styles.streamItem} ${isLast ? styles.streamCurrent : ""}`}>
              <div className={styles.streamConnector}>
                <div
                  ...
                  style={{ background: isLast ? s.color : "transparent", borderColor: s.color }}
                >
                ...
                {i < data.snapshots.length - 1 && (
                  <div className={styles.streamLine} style={{ background: s.color + "30" }} />
                )}
              </div>
                  ...
                  <div className={styles.streamThumbs}>
                    {Array.from({ length: Math.min(s.items, 4) }).map((_, j) => (
                      <div
                        ...
                        style={{ background: s.color + "12", borderColor: s.color + "20" }}
                      >
