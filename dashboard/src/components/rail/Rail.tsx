  ...
  return (
    <div className={styles.rail} role="navigation" aria-label="Main navigation">
      ...
      <button className={`${styles.btn} ${activeItem === "workspace" ? styles.active : ""}`} onClick={() => onItemClick("workspace")} aria-label="Workspace" title="workspace">
        <svg className={styles.planetIcon} width="20" height="20" viewBox="0 0 18 18" fill="none"><circle className={styles.planetBody} cx="9" cy="9" r="5.5" stroke="currentColor" strokeWidth="1.2"/><g className={styles.orbit}><ellipse cx="9" cy="9" rx="5.5" ry="2" stroke="currentColor" strokeWidth="0.8"/><circle cx="14.5" cy="9" r="1" fill="currentColor"/><circle cx="3.5" cy="9" r="0.6" fill="currentColor"/></g></svg>
      </button>
      ...
      <button className={`${styles.btn} ${activeItem === "workstations" ? styles.active : ""}`} onClick={() => onItemClick("workstations")} aria-label="Workstations" title="workstations">
        <svg className={styles.anvilIcon} width="20" height="20" viewBox="0 0 18 18" fill="none"><path d="M3 7h12c0-3-2.5-5-6-5S3 4 3 7z" stroke="currentColor" strokeWidth="1.2" strokeLinejoin="round"/><line x1="2" y1="7" x2="16" y2="7" stroke="currentColor" strokeWidth="1.3" strokeLinecap="round"/><path d="M8 7v6M10 7v6" stroke="currentColor" strokeWidth="1.2" strokeLinecap="round"/><rect x="6" y="13" width="6" height="2" rx="0.5" stroke="currentColor" strokeWidth="1.2"/><line x1="4" y1="16" x2="14" y2="16" stroke="currentColor" strokeWidth="1.3" strokeLinecap="round"/><g className={styles.spark}><line x1="9" y1="1" x2="9" y2="0" stroke="currentColor" strokeWidth="1" strokeLinecap="round"/><line x1="6" y1="1.5" x2="5" y2="0.5" stroke="currentColor" strokeWidth="1" strokeLinecap="round"/><line x1="12" y1="1.5" x2="13" y2="0.5" stroke="currentColor" strokeWidth="1" strokeLinecap="round"/><line x1="4.5" y1="3" x2="3.5" y2="2.5" stroke="currentColor" strokeWidth="0.8" strokeLinecap="round"/><line x1="13.5" y1="3" x2="14.5" y2="2.5" stroke="currentColor" strokeWidth="0.8" strokeLinecap="round"/></g></svg>
      </button>
