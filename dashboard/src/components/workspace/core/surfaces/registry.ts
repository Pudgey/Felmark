...
export const SURFACES = [
  {
    ...
    label: "Money",
    icon: "$",
    desc: "Invoices, revenue, payments",
    action: "+ New Invoice",
    shortcut: "N",
    stateVal: "$14.8k",
    stateLb: "earned",
  ...
  },
  {
    ...
    label: "Pipeline",
    icon: "\u2192",
    desc: "Deals, proposals, contracts",
    action: "+ New Deal",
    shortcut: "P",
    stateVal: "4",
    stateLb: "deals",
